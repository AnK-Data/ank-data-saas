...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* ── Painel direito ──────────────────────────────────────────── */}
      <div className="flex flex-1 flex-col items-center justify-center bg-white dark:bg-slate-950 px-8 py-12 transition-colors duration-200">
        <div className="w-full max-w-sm">
          <div className="mb-8 flex flex-col items-center lg:hidden">
            <AnkMascot height={120} className="mb-3" />
            <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">AnK Data</h1>
          </div>

          <div className="mb-6">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Acesse sua conta</h2>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400 dark:text-slate-500">Painel AnK Data</p>
          </div>

          {/* ── Toggle de modo ──────────────────────────────────────── */}
          <div className="mb-6 flex rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
            <button
              type="button"
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-medium transition-colors
                ${mode === 'ingresse'
                  ...
                  : 'bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700/50'}`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-medium transition-colors border-l border-slate-200 dark:border-slate-700
                ${mode === 'email'
                  ? 'bg-slate-900 dark:bg-slate-700 text-white'
                  : 'bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700/50'}`}
            >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 pl-10 pr-4 py-3 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-ank-400 focus:bg-white dark:focus:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-ank-200 dark:focus:ring-ank-900 transition-colors"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full rounded-xl border bg-slate-50 dark:bg-slate-800 pl-10 pr-11 py-3 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-800 focus:outline-none focus:ring-2 transition-colors ${error ? 'border-red-300 dark:border-red-700 focus:border-red-400 focus:ring-red-200 dark:focus:ring-red-900' : 'border-slate-200 dark:border-slate-600 focus:border-ank-400 focus:ring-ank-200 dark:focus:ring-ank-900'}`}
                />
